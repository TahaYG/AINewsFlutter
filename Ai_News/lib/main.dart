...
class HaberUygulamasi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // DEĞİŞİKLİK: Profesyonel ve okunabilir bir aydınlık tema.
    final lightTheme = ThemeData(
      useMaterial3: true,
      scaffoldBackgroundColor: const Color(0xFFF5F7FA), // Hafif gri/mavi arka plan
